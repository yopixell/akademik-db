...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 26 Mar 2025 pada 08.20
...
(23, 'Imam', 'Jl. Yogyakarta'),
(33, 'Resnu', 'Jl. Duku'),
(99, 'Mutiara', 'Jl. Salatiga');
...
--
ALTER TABLE `jurusan`
  ADD CONSTRAINT `fk_jurusan_dosen` FOREIGN KEY (`kode_dos`) REFERENCES `dosen` (`kode_dos`) ON DELETE SET NULL;

--
-- Ketidakleluasaan untuk tabel `matakuliah`
--
ALTER TABLE `matakuliah`
  ADD CONSTRAINT `fk_matakuliah_dosen` FOREIGN KEY (`kode_dos`) REFERENCES `dosen` (`kode_dos`) ON DELETE SET NULL;
COMMIT;
